...
export default function Turret() {
    ...
    return (
        <div>
            ...
            <p>
                Tool under construction: report issue or contrib on <a className="link-effect" target="_blank" href="https://github.com/FlorianPerrot/eve-weapons-simulator/issues">Github</a><br/>
            </p>
